package com.tautech.cclappoperators.activities.ui_urban.finished
...
class FinishedDeliveriesFragment : Fragment(), EMDKManager.EMDKListener, Scanner.StatusListener, Scanner.DataListener {
    ...
    val TAG = "FINISHED_DELIV_FRAGMENT"
    ...
    fun initAdapter() {
        ...
        processedListRv?.addItemDecoration(DividerItemDecoration(requireContext(), LinearLayoutManager.HORIZONTAL))
        processedListRv?.layoutManager = LinearLayoutManager(requireContext())
