...
class PlanificationLineAdapter(private val dataList: MutableList<Delivery>, val planification: Planification?, val context: Context):
    ...
    class MyViewHolder(val itemView: View, val _planification: Planification?): RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(delivery: Delivery? = null) {
            ...
            val percent = when(_planification?.planificationType){
